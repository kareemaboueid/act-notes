...
const update_schema_many = async (
  ...
  try {
    ...
    logger.is_schema_strict(
      _collection_name,
      `${_schema.options.strict} \`update_schema_many()\``,
    );
    ...
    logger.error({ source: 'update_schema_many' }, error);
  }
...
const update_schema_one = async (
  ...
  try {
    ...
    logger.is_schema_strict(
      _collection_name,
      `${_schema.options.strict} \`update_schema_one()\``,
    );
    ...
    logger.error({ source: 'update_schema_one' }, error);
  }

  // ------ END ------ //
};

export { update_schema_many, update_schema_one };
